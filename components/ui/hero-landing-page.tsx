...
export function TuringLanding() {
  ...
  // Make html/body transparent so the fixed shader canvas at z-index 0 shows through
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden" style={{ position: 'relative', zIndex: 1 }}>
      ...
      {/* ── Shader background — fixed fullscreen at z-index 0 ────────── */}
      <ShaderBackground />
      ...
      {/* ── Hero ───────────────────────────────────────────────────────── */}
      <main className="min-h-screen pt-[220px] pb-24" style={{ position: 'relative', zIndex: 2 }}>

        {/* Bottom fade so the How-it-works section blends in */}
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-[60px] flex flex-col lg:flex-row justify-between items-end gap-16 lg:gap-8 relative z-[2]">
          ...
          >
            ...
            <motion.div variants={fadeUp} transition={{ duration: 0.6 }}>
              <span className="inline-flex items-center gap-2 text-[#0084ff] text-[11px] uppercase tracking-[0.25em] mb-8 font-medium">
            ...
            <motion.h1
              ...
              className="text-[56px] md:text-[72px] lg:text-[80px] font-light leading-[1.05] mb-8 tracking-[-2px]"
            >
              Track every<br />
            ...
            <motion.p
              ...
              className="text-lg leading-relaxed text-[#b8b8b8] mb-12 font-normal max-w-[560px]"
            >
              Citizens flag suspicious tenders. Journalists verify.<br />
            ...
            >
              <Link
                href="/tenders"
                className="inline-flex items-center gap-2.5 bg-[#0084ff] text-white py-3.5 px-7 rounded-md text-base font-medium hover:bg-[#0066cc] hover:translate-x-0.5 transition-all duration-200"
              >
                Browse Contracts
              ...
              <Link
                href="#how-it-works"
                className="text-[#b8b8b8] py-3.5 px-5 text-base font-medium hover:text-white transition-colors duration-200"
              >
                How it works
              </Link>
            </motion.div>
          ...
          {/* ── Right: live stats ────────────────────────────────────── */}
          <motion.div
            className="flex flex-row lg:flex-row gap-12 lg:gap-20 items-end shrink-0"
            initial={{ opacity: 0, y: 24 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5, duration: 0.9, ease: "easeOut" }}
          >
            <div className="text-center">
              <div className="text-[56px] md:text-[64px] mb-2">
                <AnimatedNumber value={TENDERS.length} />
              </div>
              <div className="text-sm text-[#b8b8b8] font-normal uppercase tracking-widest">
                Contracts
              </div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              <div className="text-[56px] md:text-[64px] mb-2 text-[#0084ff]">
                {mounted
      ...
      <section id="how-it-works" className="relative py-32 px-6 md:px-[60px] max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/5 rounded-xl overflow-hidden">
          {[
            ...
            <motion.div
              ...
              className="group relative p-10 cursor-pointer overflow-hidden"
            ...
            >
              ...
              <div className="relative z-10">
                <div className="font-mono text-xs text-[#0084ff]/60 mb-6">{n}</div>
                <h3 className="text-xl font-light text-white mb-4">{title}</h3>
                <p className="text-sm text-[#b8b8b8] leading-relaxed mb-8">{body}</p>
                <Link
                  href={href}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="mt-24 flex flex-col sm:flex-row items-center justify-between gap-8 border border-white/5 rounded-xl p-10"
          style={{ background: "rgba(0,132,255,0.04)" }}
        >
          <div>
            <p className="text-2xl font-light text-white mb-2">Ready to follow the money?</p>
            <p className="text-[#b8b8b8] text-sm">Start browsing — no account needed.</p>
          </div>
          <Link
            href="/tenders"
            className="inline-flex items-center gap-2.5 bg-[#0084ff] text-white py-3.5 px-8 rounded-md font-medium hover:bg-[#0066cc] transition-colors duration-200 shrink-0"
          >
